 ...
 */
function resolveSpin(game, betAmount, gameStats, freeSpinState = null) {
    if (!freeSpinState) {
    ...
    // Free spins always allow wins (bonus round = where real value is)
    const allowWin = freeSpinState.active || houseEdge.shouldAllowWin(game, gameStats);
